...
; Returning to the desktop from a cartridge entry throws a bus error
; (two bombs) on this hardware. It is not ours: MD/JS's cartridge demo
; does the same, and dropping the Mfree below made no difference, so it
